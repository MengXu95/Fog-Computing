...
public class GPTreeConstraints implements Clique
    ...
    public void setup(final EvolutionState state, final Parameter base)
        {
        // What's my name?
        name = state.parameters.getString(base.push(P_NAME),null); //fzhang 20.6.2018 tc0 and tc1
        if (name==null)
        ...
        // Load my return type
        String s = state.parameters.getString(base.push(P_RETURNS),null); //nil nil  fzhang 20.6.2018
        if (s==null)
        ...
        //System.out.println(treetype); //fzhang 20.6.2018  nil nil
