...
public abstract class Exchanger implements Singleton
    ...
    //fzhang 21.7.2018 in order to change the rate of crossover and mutation
	public Population preBreedingExchangePopulation(SimpleEvolutionState simpleEvolutionState, Parameter base) {
