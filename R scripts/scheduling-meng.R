...
plot(1:5,1:5,xlim = c(-70,950), ylim = c(-0.5,5.5), type = "n", cex.axis = 1.5, font.axis = 1, yaxt = "n", ann = FALSE)
...
axis(side = 2, at = c(0, 1, 2, 3, 4, 5), labels = paste(c("Device 0","Device 1", "Fog 0", "Fog 1", "Cloud 0","Cloud 1")), las =2, cex.axis = 1.4, xpd = TRUE)
